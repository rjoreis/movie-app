const global = {
    ...
    api: {
        apiKey: '20b6b1a9e666e432837a20e55f58c54f',
...
async function search() {
    ...
    if (global.search.term !== '' && global.search.term !== null) {
        const  { results, total_pages, page, total, total_results } = await searchAPIData();
...
async function fetchAPIData(endpoint) {
    // Register key at https://www.themoviedb.org/settings/api
    // Only use the key for development or small projects
    // For a REAL development, store your key and make requests from a server
